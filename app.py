...
if st.session_state.search_results is not None:
    ...
    if st.session_state.is_fallback:
        ...
        <div class="warning-container">
            <span class="warning-title">❌ DEVICE TIDAK TERSEDIA</span>
            <div class="warning-text">
                Maaf, tidak ada Smartphone yang sesuai dengan budget & kriteria spesifik Anda.<br>
                Berikut adalah <b>Rekomendasi Alternatif</b> yang spesifikasinya paling mendekati keinginan Anda:
            </div>
        </div>
        """, unsafe_allow_html=True)
    elif st.session_state.trigger_balloons:
        st.balloons()
        st.session_state.trigger_balloons = False
